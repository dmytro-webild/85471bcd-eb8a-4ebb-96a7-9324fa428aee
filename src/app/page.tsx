...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/woman-showing-her-teeth-clinic_107420-65383.jpg",
          alt: "Woman showing her teeth in clinic",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-beautiful-woman-dentist_23-2148396149.jpg",
          alt: "Portrait of beautiful woman at the dentist",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-female-patient-bed-physiotherapy-center_1139-1121.jpg",
          alt: "Young female patient on bed in a physiotherapy center.",
        },
        {
          src: "http://img.b2bpic.net/free-photo/portrait-smiling-young-woman-sitting-chair-dental-clinic_662251-2583.jpg",
          alt: "Portrait of smiling young woman sitting on chair at dental clinic",
        },
      ]}
      ...
      features={[
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/dermatologist-female-patient-discussing-digital-tablet_107420-65415.jpg",
        },
        {
          id: "s2",
          title: "Professional Fillings",
          tags: [
            "Restorative",
          ],
        ...
        },
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/dental-care-tooth-decay-concept-curly-young-woman-uses-dental-floss-wears-headband-casual-striped-t-shirt-has-perfect-smile-looks-away-isolated-blue-studio-background-teeth-flossing_273609-60927.jpg",
        },
      ]}
      ...
      products={[
        {
          ...
          rating: 5,
          reviewCount: "120",
          imageSrc: "http://img.b2bpic.net/free-photo/female-facial-beautiful-clean-fresh_1301-1935.jpg",
        },
        {
          id: "p2",
          brand: "Whitening",
          ...
          rating: 5,
          reviewCount: "98",
          imageSrc: "http://img.b2bpic.net/free-photo/mixed-race-black-blonde-model-with-curly-hair-closeup-mouth-painted-with-bright-blue-lipstick-smiling-watching-camera_633478-803.jpg",
        },
        {
          id: "p3",
          brand: "Braces",
          ...
          rating: 5,
          reviewCount: "156",
          imageSrc: "http://img.b2bpic.net/free-photo/image-cheerful-beautiful-young-lifestyle-blogger-woman-sitting-floor-recording-video-about_1258-255219.jpg",
        },
        {
          id: "p4",
          brand: "Fillings",
      ...
      metrics={[
        {
          ...
          description: "Successfully treated patients across Egypt.",
          icon: Smile,
        },
        {
          id: "m2",
          ...
          description: "Deep expertise in cosmetic dentistry.",
          icon: Award,
        },
        {
          id: "m3",
          ...
          description: "Highly trusted by our local community.",
          icon: Star,
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, our advanced procedures meet the highest safety standards.",
        },
        {
          id: "f2",
          title: "How much do veneers cost?",
          content: "Costs vary based on your personal needs; contact us for a consultation.",
        },
        {
          id: "f3",
          title: "Do you offer international booking?",
          content: "Yes, we welcome patients globally for dental tourism.",
        },
      ]}
